...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by Chemistry Practice': {
        'zh-Hant': '由 Chemistry Practice 生成',
        fr: 'Genere par Chemistry Practice',
        ru: 'Сгенерировано в Chemistry Practice',
        fa: 'تولید شده توسط Chemistry Practice',
        ur: 'Chemistry Practice کی جانب سے تیار کردہ',
        tl: 'Nabuo ng Chemistry Practice'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by Chemistry Practice', '由 Chemistry Practice 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('Chemistry Practice — Balancing Chemical Equations Worksheet', 'Chemistry Practice — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by Chemistry Practice</div>
